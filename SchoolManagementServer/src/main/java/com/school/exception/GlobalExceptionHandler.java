...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> handleNoResourceFoundException(Exception e) {
		ErrorResponseDTO errorResponseDTO = new ErrorResponseDTO(HttpStatus.NOT_FOUND, "Not found");
	...
	public ResponseEntity<ErrorResponseDTO> handleNotFoundException(ResourceNotFoundException e) {
		return new ResponseEntity<>(new ErrorResponseDTO(HttpStatus.NOT_FOUND, RECORD_NOT_FOUND), HttpStatus.NOT_FOUND);
	}
