...
export const generateBillingCycleForRange = async (payload) => {
    return await apiCallNoPage('/billing/v2/billing-cycles/generate-range', 'POST', payload);
};

export const collectionForRange = async (payload) => {
    return await apiCallNoPage('/billing/v2/billing-cycles/collection-range', 'POST', payload);
};
...
export const filterBillingCycles = async (filters) => {
    ...
    return await apiCallV2WithPage(`/billing/v2/billing-cycles/filter?${queryParams.toString()}`, 'GET');
};
