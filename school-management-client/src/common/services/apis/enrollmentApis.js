...
export const searchStudentsByStudentCodeNotEnrolled = async (courseId, studentCode) =>
    await apiCallNoPage(`/education/v0/enrollments/search/findStudentsByStudentCodeNotEnrolled?courseId=${courseId}&studentCode=${studentCode}`);

export const searchStudentsByPhoneNotEnrolled = async (courseId, phone) =>
    await apiCallNoPage(`/education/v0/enrollments/search/findStudentsByPhoneNotEnrolled?courseId=${courseId}&phoneNumber=${phone}`);

export const searchStudentsByFirstNameNotEnrolled = async (courseId, firstName) =>
    await apiCallNoPage(`/education/v0/enrollments/search/findStudentsByFirstNameNotEnrolled?courseId=${courseId}&firstName=${firstName}`);

export const addStudentToCourse = async (enrollmentData) => apiCallNoPage(`/education/v2/enrollments`, 'POST', enrollmentData);
